...
if __name__ == '__main__':
    ...
    parser.add_argument('-eps_min', type=float, default=0.01, help='Minimum value for epsilon in epsilon-greedy action selection')
    parser.add_argument('-gamma', type=float, default=0.99, help='Discount factor for update equation')
    parser.add_argument('-eps_dec', type=float, default=1e-5, help='Rate of decay for epsilon')
    parser.add_argument('-eps', type=float, default=1.0, help='Starting value for epsilon')
    parser.add_argument('-max_mem', type=int, default=25000, help='Max size of memory buffer')
    ...
    # If you want to capture a video of the agent playing
    '''
        ...
        while not terminated:
            ...
            if not args.load_checkpoint:
                agent.store_transition(observation, action,
                                     reward, observation_, int(terminated))
                agent.learn()
